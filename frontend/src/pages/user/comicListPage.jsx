...
// fetch JSON an toàn (server có thể trả text/html khi lỗi)
...
export default function ComicListPage() {
  ...
  // route detail (giữ giống ComicSlider của bạn)
  ...
  const setParam = (key, val) => {
    ...
    // đổi filter thì reset trang về 1
      ...
      <div className="clp-hero">
        ...
        <div className="clp-filters">
          ...
          <div className="clp-search">
            ...
            <input value={q} onChange={(e) => setParam("q", e.target.value)} placeholder="Tìm truyện..." />
            {q ? (
          ...
          {/* Category (bạn có thể load từ API categories sau) */}
          <select value={category} onChange={(e) => setParam("category", e.target.value)} className="clp-select">
            <option value="">Tất cả thể loại</option>
            {/* ví dụ demo - đổi theo slug thật của bạn */}
